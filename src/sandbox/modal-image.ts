...
export const MODAL_DEFAULT_IMAGE_SETUP =
  "RUN apt-get update && apt-get install -y --no-install-recommends ca-certificates curl git jq tar xz-utils unzip util-linux python3 python3-venv openssh-client && rm -rf /var/lib/apt/lists/* && setsid --wait true";
