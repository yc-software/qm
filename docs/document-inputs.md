...
| --------------------------------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------- |
| OpenAI Responses                        | PDF, Word, Excel, PowerPoint, ODT, RTF, text and code                                                 | ODS and ODP use text extraction |
...
OpenAI, OpenRouter and Gemini native acceptance, encrypted/large provider inputs, and the Slack upload matrix remain release QA requirements. Local schema tests do not substitute for these checks.
