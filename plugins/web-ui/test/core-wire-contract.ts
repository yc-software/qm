...
type ApiSessionEntry = CoreSessionEntry & { editable?: boolean };

type _session = Expect<IsAssignable<Session, CoreSession>>;
type _entry = Expect<IsAssignable<ApiSessionEntry, SessionEntry>>;
...
type _entryKeys = Expect<NoExtraKeys<SessionEntry, ApiSessionEntry>>;
