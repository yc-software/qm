...
export function composerForm(agent: Agent): TemplateResult {
  ...
  if (fastAvailable) fastTitle = t(fastOn ? "Fast mode active" : "Fast mode");
  ...
  if (inputBlocked) placeholder = t(runtimePending ? "Loading runtime…" : "Approve or deny to continue");
