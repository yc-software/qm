    ...
    html`
      <div class="pane-head">
        ...
        <div class="pane-head-actions">
          ...
          >
            ${icon(Pencil, 15)} ${t(rawEditing ? "Facts view" : "Edit notebook")}
          </button>
          <button class="btn" type="button" @click=${() => void toggleHistory()}>
            ${icon(Clock3, 15)} ${t("History")}
          </button>
          <button
            class="pane-refresh"
            type="button"
      ...
      <div class="memory-editor">
                  ...
                  ${
                    visible.length
                      ...
                      : html`<div class="empty-state">
                          ${t(search ? "No remembered facts match this search." : "The agent hasn’t noted any facts yet.")}
                        </div>`
                  }
                </div>`
        }
        <div class="memory-actions">
          ...
          >
            ${t(memorySaving ? "Saving…" : "Save changes")}
          </button>
            ...
            ? html` <section class="memory-history">
                ...
                ${
                  history.length
                    ? history.map(
                        (row, i) =>
                          html` <div class="memory-revision">
                            <div>
                              <strong
                                >${i === 0 ? t("Current") : t("Revision {revision}", { revision: row.revision })}</strong
                              >
                              <div class="card-meta">
                    ...
                    : html`<div class="empty-state">
                        ${t("Revision history is unavailable for this memory store.")}
                      </div>`
                }
              </section>`
            : nothing
