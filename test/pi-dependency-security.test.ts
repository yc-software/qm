...
const piCodingAgentTarball =
  "https://github.com/TrueKrishna/pi/releases/download/qm-pi-coding-agent-0.82.0-security.3/earendil-works-pi-coding-agent-0.82.0-qm-security.3.tgz";
...
test("Pi and MCP security overrides are materialized by the root lockfile", () => {
  ...
  assert.equal(dependencyVersion(piManifest, "undici"), "8.10.0");
