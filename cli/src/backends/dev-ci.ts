...
function requireEnv(): void {
  ...
  if (
    ...
    die(
      "a model provider key or HARNESS=grok subscription required (ANTHROPIC_API_KEY, OPENAI_API_KEY, OPENROUTER_API_KEY, or XAI_API_KEY — live turns are the point of this instance)",
    );
  }
